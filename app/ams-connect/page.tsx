...
export default async function AmsConnectPage() {
  ...
  return (
    <CenteredCard>
      <div
        className={`w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6 ${isConnected ? 'bg-green-100' : 'bg-orange-100'}`}
      >
        {isConnected ? (
          <svg
      ...
      {isConnected ? (
        <>
          ...
          <p className="text-sm text-gray-400 mb-8">
            Shop ID: {tokens.shop_id} &nbsp;·&nbsp; Token expires:{' '}
        ...
        <>
          ...
          <p className="text-gray-500 mb-2 leading-relaxed">
            Authorize the Affiliate Marketing Solution Management app to access your AMS conversion
            report data.
          </p>
          <p className="text-sm text-gray-400 mb-8">
