...
const orders: ShopeeOrderDetail[] = [
  {
    ...
    item_list: [{ item_id: 1, item_name: 'Widget', model_quantity_purchased: 2, model_discounted_price: 50 }],
  },
  {
    order_sn: 'A2',
    order_status: 'COMPLETED',
    ...
    item_list: [{ item_id: 2, item_name: 'Gadget', model_quantity_purchased: 1, model_discounted_price: 50 }],
  },
  {
    order_sn: 'A3',
    order_status: 'COMPLETED',
    ...
    item_list: [{ item_id: 1, item_name: 'Widget', model_quantity_purchased: 1, model_discounted_price: 75 }],
  },
];
