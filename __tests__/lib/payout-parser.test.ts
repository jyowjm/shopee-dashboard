...
function buildTestXlsx(): Buffer {
  ...
  const incomeData = [
    ...
    [
      ...
      0,
      13,
      -4.9, // col 14 = shipping 13, col 15 = logistic fee
      0,
      4.9,
      0,
      0,
      ...
      0,
      '0.00',
      0, // col 31 = AMS, col 32 = Saver, col 33 = Ads
      'buyer1',
      61.37,
      3.78, // col 34 = Username, col 35 = Amount, col 36 = TxnRate
      'Online Banking',
      '',
      '', // col 37 = PaymentMethod, col 38 = PM Details, col 39 = Installment
      '0.00',
      '2-Day Delivery',
      'SPX Express (2DD)',
      '',
