...
Different fees use different bases. All bases start from the payout report's **"Product Price"** column, which is the deal price *after item rebates* but *before* seller vouchers.
